  ...
  return (
    <section className="relative flex flex-col items-center justify-between ">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-12 md:pb-10 lg:pt-10">
          ...
          <div className="my-6 flex items-center gap-3 lg:gap-5">
            ...
            >
              <Leetcode />
              <span className="hidden">Leetcode Icon</span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <button className="cursor-pointer px-2 text-xs md:px-8 py-3 md:py-4 bg-[#0d1224] rounded-full border-none text-center md:text-sm font-medium uppercase tracking-wider text-[#ffff] no-underline transition-all duration-200 ease-out  md:font-semibold flex items-center gap-2 hover:gap-3">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Vidushi Malik</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
